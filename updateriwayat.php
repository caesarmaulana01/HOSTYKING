...
<?php
$riwayat_tindakan = mysqli_query($conn, "UPDATE riwayat_tindakan SET harga = '$lay' WHERE id_penyakit = '$id_penyakit' AND id_tindakan=3");
$riwayat_inap = mysqli_query($conn, "INSERT INTO riwayat_rawatinap (id_pasien, tgl_masuk, tgl_keluar, biaya) VALUES ('$id', '$tglmasuk', '$datenow', '$lay')");
$ruangan = mysqli_query($conn, "UPDATE ruang_inap SET id_pasien = NULL, tgl_masuk = NULL, jam_masuk = NULL, status='0' WHERE id='$idruang'");
?>