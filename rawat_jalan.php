...
<head>
  ...
  if (isset($_POST['jalan3'])) {
    ...
    mysqli_query($conn, "INSERT INTO riwayat_penyakit (id_pasien, penyakit, hasil_pemeriksaan, tgl, id_rawatinap, biaya_pengobatan) VALUES ('$idpasien', '$penyakit', '$hasil_pemeriksaan', '$tglnow', '0', '$biaya')");
  }
                        ...
                        if (isset($_POST['jalan2'])) { ?>
                          ...
                          <div class="card-body">
                            ...
                            <div class="form-group row mb-4">
                              ...
                              <div class="col-sm-12 col-md-7">
                                <textarea placeholder="Wajib" class="summernote" name="hasil_pemeriksaan">Wajib Diisi</textarea>
                              </div>
                            </div>
                            <div class="form-group row mb-4">
