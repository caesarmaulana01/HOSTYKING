...
<head>
  ...
  $idnama = $_POST['id'];
  $page1 = "detron";
  $page = "Foto Rontgen Pasien : " . $idnama;
  session_start();
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Foto Rontgen Pasien</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="pasien_admin.php">Foto Rontgen</a></div>
              <div class="breadcrumb-item">Foto Rontgen : <?php echo ucwords($idnama); ?></div>
            </div>
          </div>
            ...
            <div class="section-body">
              ...
              <div class="row">
                <div class="col-12">
                  <div class="card">
                    <div class="card-header">
                      <h4>Semua Foto Rontgen Penyakit : <?php echo $echopen['penyakit']; ?></h4>
                    </div>
                    <div class="card-body">
